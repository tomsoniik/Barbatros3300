...
func GenerateLinuxStub(outputFile string) {
	...
	stub = strings.Replace(stub, "BARBATROS2137_REPLACE_ME_BOOTSTRAPS", strings.Join(bootstraps[:], ",\n"), -1)
	stub = strings.Replace(stub, "BARBATROS2137_REPLACE_ME_TOX_ID", Tox_instance.SelfGetAddress(), -1)
	stub = strings.Replace(stub, "BARBATROS2137_REPLACE_ME_PUB_KEY", Tox_instance.SelfGetPublicKey(), -1)
